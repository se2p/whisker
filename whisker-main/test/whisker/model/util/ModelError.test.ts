...
describe('ModelError', () => {
    function getEdge(): ProgramModelEdge {
        ...
        edge.addCondition(new Expr("label", {id: "c1", negated: false, args: ["true"]}));
        edge.addCondition(new Key("label", {id: "c2", negated: true, args: ["a"]}));
        return edge;
    }

    test("getEffectFailedOutput()", () => {
        const edge = getEdge();
        const effect = new AttrChange("label", {id: "e1", negated: false, args: ["Apple", "x", "+"]});
    ...
    test("getEffectFailedOutput() with TimeBetween", () => {
        const edge = getEdge();
        edge.addCondition(new TimeBetween("label", {id: "c4", negated: true, args: [123]}));
        const effect = new AttrComp("label", {id: "e1", negated: false, args: ["Apple", "x", ">", "0"]});
    ...
    test("getEffectFailedOutput() with TimeElapsed", () => {
        const edge = getEdge();
        edge.addCondition(new TimeElapsed("label", {id: "c3", negated: true, args: [456]}));
        const effect = new AttrChange("label", {id: "e1", negated: false, args: ["Apple", "x", "+"]});
    ...
    test("getEffectFailedOutput() with TimeElapsed and TimeAfterEnd", () => {
        const edge = getEdge();
        edge.addCondition(new TimeAfterEnd("label", {id: "c5", negated: true, args: [789]}));
        edge.addCondition(new TimeElapsed("label", {id: "c4", negated: true, args: [456]}));
        const effect = new AttrChange("label", {id: "e1", negated: false, args: ["Banana", "x", "+"]});
    ...
    test("getTimeLimitFailedAfterOutput()", () => {
        const condition = new Expr("label", {id: "c6", negated: false, args: ["$(Bowl.x)>0"]});
    ...
    test("getTimeLimitFailedAtOutput()", () => {
        const condition = new Click("label", {id: "c6", negated: false, args: ["Bowl"]});
