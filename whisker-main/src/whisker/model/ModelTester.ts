...
export class ModelTester extends EventEmitter {
     ...
     * @param useUserModel Whether inputs should be generated by a user model if at least one is present
     */
    async prepareModel(testDriver: TestDriver, useUserModel: boolean) {
        console.log("----Preparing model----");
        this.useUserModel = useUserModel;
    ...
    private userInputGen(t: TestDriver, modelResult: ModelResult) {
        if (this.useUserModel && this.userModelsDefined()) {
