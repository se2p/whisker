...
export class StateActionRecorder extends EventEmitter {
    ...
    private _handleKeyBoardInput(actionData): ScratchEvent | null {
        ...
        if (actionData.isDown && actionData.key !== null) { // Start of key press or key is still pressed.
            ...
            if (!this._pressedKeys.has(key)) {
                ...
                this._stateAtAction.set(new KeyPressEvent(key).stringIdentifier(), FeatureExtraction.getFeatureMap(this._vm));
            }
    ...
    private _handleMouseInput(actionData): ScratchEvent | null {
        ...
        if (!this._stateAtAction.has(this.MOUSE_MOVE_ACTION_KEY) && !('isDown' in actionData) &&
            ...
            this._checkForWait(false);
            this._stateAtAction.set(this.MOUSE_MOVE_ACTION_KEY, FeatureExtraction.getFeatureMap(this._vm));
        }
        ...
        if ('isDown' in actionData) {
            ...
            if (actionData.isDown) {
                ...
                if (availableActions.includes(new ClickSpriteEvent(clickTarget).stringIdentifier())) {
                    ...
                    this._checkForWait(false);
                    this._stateAtAction.set(this.MOUSE_DOWN_ACTION_KEY, FeatureExtraction.getFeatureMap(this._vm));
    ...
    private _recordAction(event: ScratchEvent): void {
        ...
        if (this._stateAtAction.has(action)) {
            ...
            stateFeatures = FeatureExtraction.getFeatureMap(this._vm);
        }
        ...
        this._stateAtAction.set("WaitEvent", FeatureExtraction.getFeatureMap(this._vm));
    }
